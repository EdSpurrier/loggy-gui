...
<div id="content" data-file-selected="0" data-page-template="<?php echo $page_template; ?>">
    ...
    <?php
        include("templates/file_slide_orders.php");
        include("templates/file_slide_containers.php");

        if ($_SESSION["user_type"] == 'super_admin' || $_SESSION["user_type"] == 'admin') {
            include("templates/file_slide_grabs.php");
            include("templates/file_slide_logs.php");
        };
...
<?php
    ...
    include("templates/comms_panel.php");
